...
pdf('../plots/Figure_4/wilcox_all.pdf', width = 8, height = 3.5)
barplot(ggg, las = 2)
dev.off()
...
pdf('../plots/Figure_4/wilcox_ad.pdf', width = 3, height = 3.5)
...
pdf('../plots/Figure_4/wilcox_noad.pdf', width = 3, height = 3.5)
